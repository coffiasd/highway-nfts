    ...
    return (
        <footer className="footer p-10 bg-slate-300 text-base-content">
            <div>
                ...
                <a className={styles.footerHover}>Design</a>
                <a className={styles.footerHover}>Marketing</a>
                <a className={styles.footerHover}>Advertisement</a>
            </div>
            <div>
                <span className="footer-title text-black">Company</span>
                <a className={styles.footerHover}>About us</a>
